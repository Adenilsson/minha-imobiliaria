    ...
    <div class="container  my-5 py-5">
      ...
      <div class="swiper residence-swiper">
        <div class="swiper-wrapper">
            @foreach ($detalhes->imagens as $i)
                <div class="swiper-slide">
                    <div class="card">
                        <a href="index.html"><img src="{{ asset('storage/'.$i->path)}}" class="card-img-top detalhe-img" alt="image"></a>
                    </div>
                </div>
            @endforeach
        </div>
        <div class="card-body p-0">
            ...
            <div class="card-text">
              <ul class="d-flex">
                <li class="residence-list"> <img src="{{ asset('storage/images/bed.png')}}" alt="image"> 4 bedroom</li>
