    ...
    <div class="container">
      <div class="row py-lg-5">
        ...
        <div class="text-center col-lg-4">
          <img src="{{ asset('storage/images/search.png')}}" class="bd-placeholder-img rounded-circle" alt="Bootstrap Themes" width="140"
        ...
        <div class="text-center col-lg-4">
          <img src="{{ asset('storage/images/price.png')}}" class="bd-placeholder-img rounded-circle" alt="Bootstrap Themes" width="140"
            height="140" loading="lazy">
        ...
        <div class="text-center col-lg-4">
          <img src="{{ asset('storage/images/time.png')}}" class="bd-placeholder-img rounded-circle" alt="Bootstrap Themes" width="140"
            height="140" loading="lazy">
